    ...
    return (
        <div className="animate-scale-in">
            ...
            <div className="mb-6 text-center">
                ...
                {/* Progress Bar */}
                <div className="mx-auto mb-4 h-2 w-64 overflow-hidden rounded-full bg-white/20">
                    <div
            ...
            {/* Question Card */}
            <div className="glass-effect-strong mx-auto max-w-4xl rounded-3xl p-8 shadow-2xl">
                <h2 className="text-center text-3xl font-black text-gray-800">
                    {question}
                </h2>
            </div>
        </div>
